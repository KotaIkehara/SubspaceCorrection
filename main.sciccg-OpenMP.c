...
// void biccg(int n, int nonzeros, int m_max, double *A, double *B, int
// *col_ind,
//            int *row_ptr, int gamma, double *ad, int zite, double *diag,
//            int *iuhead, int *iucol, double *u, double *solx, double *bab) {
//   int i, j, k;
